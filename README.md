...
### How to build
1. Copy osx-toolchains.xml to toolchains.xml and modify the java bin path  to match your own
1. Build,test and package
```
  mvn verify --global-toolchains ./toolchains.xml -Dmaven.javadoc.skip=true -V -B
```

#### Install without running tests
```
mvn install --global-toolchains ./toolchains.xml -Dmaven.test.skip
```
